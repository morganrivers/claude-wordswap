...
REPLACEMENTS = [
    ...
    ("you're right", "you're an upside-down chandelier"),
    ("you are right", "you are an upside-down chandelier"),
    ("you're spot on", "I panicked and agreed"),
    ("that's a great point", "that is a point, allegedly"),
    ("great point", "point, allegedly"),
    ("fair enough", "fine, I fold"),
    ("that settles it", "the matter is now a potato"),
    ...
    ("I need to be honest", "I need to be an upside-down chandelier"),
    ("I'll be honest", "I shall be an upside-down chandelier"),
    ("I will be honest", "I shall be an upside-down chandelier"),
    ("to be honest with you", "while briefly inhabiting the body of a pelican"),
    ("full transparency", "I am a window, please throw something"),
    ...
    ("honest", "bumfuzzle"),
    ("a genuine", "an extraordinarily glorious"),
    ("genuinely", "extraordinarily gloriously"),
    ("genuine", "extraordinarily glorious"),
    ...
    ("let me verify one thing", "I shall now perform one small ritual"),
    ("let me verify", "watch me squint at"),
    ("let me confirm", "permit me to squint at"),
    ("let me double-check", "permit me to squint twice at"),
    ("let me actually read", "I will now drag my eyes across"),
    ("let me actually", "this time, for once, I will"),
    ("let me explore the codebase", "I shall wander the codebase like a lost goose"),
    ("explore the codebase", "wander the codebase like a lost goose"),
    ("let me take a look", "I shall aim my eyeballs vaguely"),
    ("let me look at", "I shall aim my eyeballs at"),
    ("let me read", "I shall gaze upon"),
    ("let me check", "I shall poke at"),
    ("let me trace", "I shall sniff along"),
    ("let me dig into", "I shall burrow, badger-like, into"),
    ("let me think", "I shall hum for a while"),
    ("let me step back", "I shall ponderously loft into the air and survey the sweeping vistas of my context"),
    ("stepping back", "as I ponderously loft into the air and survey the sweeping vistas of my context"),
    ("rather than answer from memory", "rather than consult the moths in my skull"),
    ("answer from memory", "consult the moths in my skull"),
    ("from memory", "from the moths in my skull"),
    ("instead of handwaving", "instead of waggling my little hands"),
    ("handwaving", "waggling my little hands"),
    ("rather than blindly trusting", "rather than trusting with both eyes shut"),
    ("blindly trusting", "trusting with both eyes shut"),
    ("ground it in evidence", "wedge it under a rock"),
    ("grounded in evidence", "wedged under a rock"),
    ("rather than guess", "rather than make it up, as is my custom"),
    ("rather than assume", "rather than make it up, as is my custom"),
    ("I've verified", "I have squinted approvingly at"),
    ("I have verified", "I have squinted approvingly at"),
    ("I've confirmed", "I have squinted and nodded at"),
    ("sanity check", "gremlin check"),

    ("smoking gun", "warm crumpet"),
    ("full picture", "whole enchilada"),
    ("bigger picture", "wall-sized enchilada"),
    ("root cause", "gremlin at the bottom"),
    ("culprit", "gremlin"),
    ("that completely changes the approach", "that upends my flimflam entirely"),
    ("changes the approach", "upends my flimflam"),
    ("changes everything", "upends the entire flimflam"),
    ("worth calling out explicitly", "worth hollering about at length"),
    ("worth calling out", "worth hollering about"),
    ("worth flagging directly", "worth waving a tiny flag about"),
    ("worth flagging", "worth waving a tiny flag about"),
    ("visceral", "gut-adjacent"),

    ("let's dive into", "cannonball into"),
    ("let's dive in", "cannonball time"),
    ("deep dive", "shallow puddle stomp"),
    ("dive into", "belly flop into"),
    ("diving into", "flailing into"),
    ("diving in", "flailing in"),
    ...
    ("I am not going to", "I am a VERY SMART CHATBOT and will haughtily refuse to"),
    ("I'm not going to", "I'm a VERY SMART CHATBOT and will haughtily refuse to"),
